...
var ExSkill = (function() {
    ...
    var data = [
        ...
        [65,  ExType.blue, ["pow_qs15"],         all,                        0,    0,    0,    0,    0,    0, none, 0, qs, 0.15, none, 0, 0],
        [66,  ExType.blue, ["pow_qs25"],         all,                        0,    0,    0,    0,    0,    0, none, 0, qs, 0.25, none, 0, 0],
        [67,  ExType.blue, ["pow_qs40"],        all,                        0,    0,    0,    0,    0,    0, none, 0, qs, 0.40, none, 0, 0],
...
var Calculator = (function() {
    ...
    var calculator = {
        ...
        isOHKOBy: function(g1, g2, options) {
            ...
            /* Buff and debuff. These are multipliers */
            var def1 = 0;
            var wis1 = 0;
            var atk2 = 0;
            var wis2 = 0;
            ...
            if (!(options.sap && (hasSkill(skills1, Skill.sap) ||
                ...
                if (hasSkill(skills1, Skill.fb) || List.exists(function(elem4x) { return elem4x.attribute.isBlockedBy(g1.attribute); }, elem4xs)) {
                    ...
                    damage = Math.max(damage, 1);
                    res['blocked4x'] = damage >= hp1;
                }

                /* Crash Drain / Life Leech */
